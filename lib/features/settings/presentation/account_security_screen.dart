    ...
    return SettingsSectionCard(
      ...
      child: AsyncValueView<List<ActiveSession>>(
        ...
        builder: (context, sessions) {
          if (sessions.isEmpty) {
            return const EmptyState(icon: Icons.devices_other_outlined, title: 'No active session data', message: 'No sessions');
          }
          return Column(
    ...
    return SettingsSectionCard(
      ...
      child: AsyncValueView<List<SecurityLogEntry>>(
        ...
        builder: (context, entries) {
          if (entries.isEmpty) {
            return const EmptyState(icon: Icons.history_rounded, title: 'No recent security history found.', message: 'No logs');
          }
          return Column(
            children: [
